    ...
    bg-accent rounded-[45px] p-[50px] md:p-[60px] relative">
      <div className="md:pr-[22rem]">
        ...
        <p className="my-10 text-xl">
          Liên hệ với chúng tôi ngay hôm nay để tìm hiểu cách các dịch vụ marketing số 
          của chúng tôi có thể giúp doanh nghiệp bạn phát triển và thành công trên môi trường trực tuyến.
        </p>
